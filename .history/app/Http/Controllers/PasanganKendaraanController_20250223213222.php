...
class PasanganKendaraanController extends Controller
{
    ...
    public function index()
    {
        ...
        ->where('status_maintenance', '=', '0')
        ->whereNotNull('kendaraans.id_pengemudi') // Cek id_pengemudi tidak null
        ->get();
    

    $pengemudis = Pengemudi::where('status', 1)->get();
    ...
    return redirect()->route('pasanganKendaraan.index')->with('success', 'Pengemudi berhasil diperbarui');
}
