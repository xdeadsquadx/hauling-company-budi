...
class JadwalController extends Controller
{
    ...
    {
        $kendaraans = Kendaraan::where('status_maintenance', 1)
        ->join('pengemudis','pengemudis.id_pengemudi', 'kendaraans')
        ->orderBy('beban_kerja', 'asc') // Urut dari beban kerja terkecil
