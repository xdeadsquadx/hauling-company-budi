...
public function edit($id)
{
    ...
    public function kirim($id, $id_kelas_pengemudi)
    {
        ...
        // Hapus kelas_pengemudi dengan id_kelas_pengemudi tertentu
        kelas_pengemudi::where('id_pengemudi', $id)
            ...
            kelas_pengemudi::where('id_kelas', $id_kelas)->update(
                ['jumlah_peserta'-> count(kelas_pelatihan::where('id_kelas', $id_kelas)->get())]
            )
