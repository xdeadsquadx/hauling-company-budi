    ...
    <div class="content">
        ...
        <form action="{{ route('kendaraan.create') }}" method="POST">
            ...
            <div class="form-group">
                <label for="pe">pe Kendaraan</label>
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="status_maintenance" id="siapJalan" value="1" checked>
                    <label class="form-check-label" for="siapJalan">Siap Jalan</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="status_maintenance" id="dalamMaintenance" value="0">
