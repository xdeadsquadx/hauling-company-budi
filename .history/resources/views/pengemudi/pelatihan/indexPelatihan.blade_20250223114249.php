...
<body class="">
    ...
    <div class="content">
        ...
        <div class="edit-bar">
            ...
            <a href="{{ route(pelatihan.) }}"><button type="button" class="btn btn-success">Tambah <i class="bi bi-plus-circle"
        ...
        <div class="list-pelatihan">
           @foreach ($kelas_pelatihans as $kelas )
            ...
            <div class="box-pelatihan">
                ...
                <a href="{{ route('pelatihan.edit', $kelas->id_kelas) }}"><button class="btn btn-primary">Edit</button></a>
            </div>
