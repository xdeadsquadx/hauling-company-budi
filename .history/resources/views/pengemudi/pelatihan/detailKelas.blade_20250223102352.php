    ...
    <div class="content">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row">{{ $detail->plat_kendaraan }}</th>
                    <td>{{ $detail->jenis_detail }}</td>
                    <td>{{ $detail->tanggal_terbit }}</td>
                    <td>{{ $detail->tanggal_expired }}</td>
                    <td>{!! $detail->periode >= 90
                        ? "<button type='button' class='btn btn-success'>$surat->periode hari hingga expired</button>" 
                        : "<button type='button' class='btn btn-danger'>$surat->periode hari hingga expired</button>" 
                    !!}</td>
