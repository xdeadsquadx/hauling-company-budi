        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{!! $pengemudi->status === 0 ? "<button type='button' class='btn btn-secondary'>Sedang Pelatihan</button>" : "<button type='button' class='btn btn-secondary'>Siap Jalan</button>" !!}}</td>
