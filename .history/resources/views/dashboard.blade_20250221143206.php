...
<body>
    ...
    fetch(url) 
        ...
        .then(html => {
            ...
            let newContent = doc.body.innerHTML; // Ambil isi <body> dari halaman yang di-load

            document.getElementById("content-area").innerHTML = newContent; // Masukin ke konten utama
        })
