...
<body class="">
    ...
    <div class="content">
        ...
        <div class="edit-bar">
            <div>
                <input type="text" placeholder="cari kendaraan" style="font-size: larger; min-height: auto; ">
                <button type="button" class="btn btn-secondary" style="min-height: auto"><i class="bi bi-search"></i></button>
            </div>
