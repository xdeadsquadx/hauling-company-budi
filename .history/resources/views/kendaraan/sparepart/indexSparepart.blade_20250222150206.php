...
<body class="">
    ...
    <div class="content">
        ...
        <div class="edit-bar">
            ...
            <div>
                <button type="button" class="btn btn-danger"><?php if(isset(count($spareparts_kurang)){
                    echo count($spareparts_kurang);
                    else{
                        echo 0;
                    }

                }   ?> &nbsp;<i style="ml-3px" class="bi bi-exclamation-triangle"></i></button>    
