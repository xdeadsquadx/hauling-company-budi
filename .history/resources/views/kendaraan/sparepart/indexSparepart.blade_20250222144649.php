...
<body class="">
    ...
    <div class="content">
        ...
        <div class="edit-bar">
            ...
            <div>
                <button type="button" class="btn btn-danger">0 &nbsp;<i style="ml-3px" class="bi bi-exclamation-triangle"></i></button>    
                <a href="{{ route('kendaraan.create') }}"><button type="button" class="btn btn-success">Tambah Sparepart</button><a>
            </div>
        </div>
