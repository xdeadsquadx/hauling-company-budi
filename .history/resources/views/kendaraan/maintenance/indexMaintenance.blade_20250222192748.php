        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $maintenance->plat_kendaraan }}</td>
                    <td>{{ $maintenance->created_at }}</td>
                    <td>{{ $maintenance->estimasi }}</td>
                    <td>{{ $maintenance->keterangan }}</td>
                    <td><button type="button" class="btn btn-danger">Hapus</button>
                        <form action="{{ route('maintenance.status', $maintenance->id_maintenance) }}" method="POST" style="display:inline;">
                            @csrf
