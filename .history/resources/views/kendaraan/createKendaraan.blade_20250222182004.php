        ...
        <form action="{{ route('kendaraan.create') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="status_maintenance" id="siapJalan" value="true" checked>
                    <label class="form-check-label" for="siapJalan">Siap Jalan</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="status_maintenance" id="dalamMaintenance" value="false">
