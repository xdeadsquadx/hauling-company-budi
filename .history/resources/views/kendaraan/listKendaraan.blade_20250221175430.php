...
<div class="content">
    ...
    <div class="edit-bar"><input type="text" id="tanggalPicker" placeholder="Pilih Tanggal"> <button type="button" class="btn btn-danger">Hapus</button><button type="button" class="btn btn-primary">Ganti</button>
    </div>
