    ...
    <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ ($kendaraan->status_maintenance) === 1 ? "<button type='button' class='btn btn-success'>Siap Jalan</button>" : "<button type='button' class='btn btn-danger'>Sedang Maintenance</button>" }}</td>
