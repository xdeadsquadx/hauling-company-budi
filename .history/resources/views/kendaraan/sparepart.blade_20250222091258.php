...
<body class="">
    ...
    <div class="content">
        ...
        <div class="edit-bar">
            <div>
                <input type="text" placeholder="cari kendaraan" style="font-size: larger; min-height: 20px; ">
                <button type="button" class="btn btn-secondary" style="min-height: 20px"><i class="bi bi-search"></i></button>
            </div>
