...
<div class="content">
    ...
    <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            <form action="{{ route('pasanganKendaraan.update', ['id' => $kendaraan->id_kendaraan]) }}" method="POST">
              @csrf
              @method('PUT')
              ...
              <td>
                  <a href="{{ route('pasanganKendaraan.update', ['id' => $kendaraan->id_kendaraan]) }}"><button type="submit" class="btn btn-success btn-sm">Update</button></a>
              </td>
          </form>
