...
<div class="content">
    ...
    <input type="text" id="tanggalPicker" placeholder="Pilih Tanggal"><button type="button" class="btn btn-danger">Hapus</button><button type="button" class="btn btn-primary">Ganti</button>
