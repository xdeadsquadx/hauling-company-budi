...
Route::get('/pelatihan', [SuratKendaraanController::class, 'index'])->name('pelatihan.index');
Route::get('/pelatihan/tambah', [SuratKendaraanController::class, 'create'])->name('pelatihan.create');
Route::post('/pelatihan/tambah', [SuratKendaraanController::class, 'store'])->name('pelatihan.store');

Route::get('/pelatihan', function () {
    return view('pengemudi/pelatihan/indexPelatihan');
})->name('pelatihan');
