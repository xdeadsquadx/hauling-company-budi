...
Route::get('/surat_kendaraan', [surat_kendaraanController::class, 'index'])->name('surat_kendaraan.index');
Route::get('/surat_kendaraan/tambah', [surat_kendaraanController::class, 'create'])->name('surat_kendaraan.create');
Route::post('/surat_kendaraan/tambah', [surat_kendaraanController::class, 'store'])->name('surat_kendaraan.store');
Route::get('/surat_kendaraan/{surat_kendaraan}/edit', [surat_kendaraanController::class, 'edit'])->name('surat_kendaraan.edit');
Route::put('/surat_kendaraan/{surat_kendaraan}', [surat_kendaraanController::class, 'update'])->name('surat_kendaraan.update');
Route::delete('/surat_kendaraan/{surat_kendaraan}', [surat_kendaraanController::class, 'destroy'])->name('kendaraan.destroy');
