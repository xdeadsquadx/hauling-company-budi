...
Route::get('/pelatihan/edit/{id}', [KelasPelatihanController::class, 'edit'])->name('pelatihan.edit');
Route::put('/pelatihan/kirim/{id}/{id_kelas_pengemudi}', [KelasPelatihanController::class, 'kirim'])->name('pelatihan.kirim');
