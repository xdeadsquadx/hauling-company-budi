...
Route::get('/kendaraan', [sparepaController::class, 'index'])->name('sparepa.index');
Route::get('/sparepa/tambah', [sparepaController::class, 'create'])->name('sparepa.create');
Route::post('/sparepa/tambah', [sparepaController::class, 'store'])->name('sparepa.store');
Route::get('/sparepa/{sparepa}/edit', [sparepaController::class, 'edit'])->name('sparepa.edit');
Route::put('/sparepa/{sparepa}', [sparepaController::class, 'update'])->name('sparepa.update');
Route::delete('/sparepa/{sparepa}', [sparepaController::class, 'destroy'])->name('sparepa.destroy');
