...
Route::get('/surat_kendaraan/{surat_kendaraan}/edit', [SuratKendaraanController::class, 'edit'])->name('surat_kendaraan.edit');
Route::put('/surat_kendaraan/{surat_kendaraan}', [SuratKendaraanController::class, 'update'])->name('surat_kendaraan.update');
Route::delete('/surat_kendaraan/{surat_kendaraan}', [SuratKendaraanController::class, 'destroy'])->name('kendaraan.destroy');
