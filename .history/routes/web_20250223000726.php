...
Route::get('/pelat', [SuratKendaraanController::class, 'index'])->name('pelat.index');
Route::get('/pelat/tambah', [SuratKendaraanController::class, 'create'])->name('pelat.create');
Route::post('/pelat/tambah', [SuratKendaraanController::class, 'store'])->name('pelat.store');
