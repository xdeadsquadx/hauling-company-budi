...
Route::get('/pelatihan', [kelController::class, 'index'])->name('pelatihan.index');
Route::get('/pelatihan/tambah', [kelController::class, 'create'])->name('pelatihan.create');
Route::post('/pelatihan/tambah', [kelController::class, 'store'])->name('pelatihan.store');
