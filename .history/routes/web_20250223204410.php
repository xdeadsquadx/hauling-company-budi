...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('jadwalHauling')->name('jadwalHauling.')->group(function () {
        Route::get('/', [jadwa::class, 'index'])->name('index');
        Route::get('/tambah', [jadwa::class, 'create'])->name('create');
        Route::post('/tambah', [jadwa::class, 'store'])->name('store');
    });

    // Surat Kendaraan
    Route::prefix('suratKendaraan')->name('surat_kendaraan.')->group(function () {
    ...
    Route::prefix('pelatihan')->name('pelatihan.')->group(function () {
        ...
        Route::put('/edit/{id}', [KelasPelatihanController::class, 'edit'])->name('edit');
        Route::put('/kirim/{id}/{id_kelas_pengemudi}', [KelasPelatihanController::class, 'kirim'])->name('kirim');
    });


        Route::prefix('pasangan-kendaraan')->name('pasanganKendaraan.')->group(function () {
            ...
            Route::put('/{id}', [PasanganKendaraanController::class, 'update'])->name('update');
            Route::put('/kirim/{pasanganKendaraan}/{kelasPengemudi}', [PasanganKendaraanController::class, 'kirim'])->name('kirim');
        });
