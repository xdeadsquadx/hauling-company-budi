...
Route::get('/surat_kendaran', [surat_kendaranController::class, 'index'])->name('surat_kendaran.index');
Route::get('/surat_kendaran/tambah', [surat_kendaranController::class, 'create'])->name('surat_kendaran.create');
Route::post('/surat_kendaran/tambah', [surat_kendaranController::class, 'store'])->name('surat_kendaran.store');
Route::get('/surat_kendaran/{surat_kendaran}/edit', [surat_kendaranController::class, 'edit'])->name('surat_kendaran.edit');
Route::put('/surat_kendaran/{surat_kendaran}', [surat_kendaranController::class, 'update'])->name('surat_kendaran.update');
Route::delete('/surat_kendaran/{surat_kendaran}', [surat_kendaranController::class, 'destroy'])->name('kendaraan.destroy');
