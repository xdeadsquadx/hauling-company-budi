...
Route::get('/surat_kendaraan', [SuratKendaraan::class, 'index'])->name('surat_kendaraan.index');
Route::get('/surat_kendaraan/tambah', [SuratKendaraan::class, 'create'])->name('surat_kendaraan.create');
Route::post('/surat_kendaraan/tambah', [SuratKendaraan::class, 'store'])->name('surat_kendaraan.store');
Route::get('/surat_kendaraan/{surat_kendaraan}/edit', [SuratKendaraan::class, 'edit'])->name('surat_kendaraan.edit');
Route::put('/surat_kendaraan/{surat_kendaraan}', [SuratKendaraan::class, 'update'])->name('surat_kendaraan.update');
Route::delete('/surat_kendaraan/{surat_kendaraan}', [SuratKendaraan::class, 'destroy'])->name('kendaraan.destroy');
